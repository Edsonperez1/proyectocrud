                ...
                <div class="container-alta">
                    ...
                    <form action="test.php" method = "POST">
                        ...
                        <div class="input-box">
                            ...
                            <input name = "nameC" type="text" autocomplete= "off" placeholder="Ingresa su nombre(s)" autofocus required>
                        </div>
                        <div class="input-box">
                            <span class="details">Descripción*</span>
                            <input name = "desc" type="text" autocomplete= "off" placeholder="Ingresa su Apellido(s)" required>
                        </div>
                        <div class="input-box">
                            <span class="details">Departamento*</span>
                            <input name = "departamento" type="text" autocomplete= "off" placeholder="Ingresa su Apellido(s)" required>
                        </div>
                        </div>
                        <div class="button">
