...
$client = new MongoDB\Client('mongodb+srv://adminn:E23x15ic623@cluster0.nmobu9x.mongodb.net/');
...
function actualizarDato($nombre, $apellidos, $dato, $nuevoDato) {
    $collection = (new MongoDB\Client('mongodb+srv://adminn:E23x15ic623@cluster0.nmobu9x.mongodb.net/'))->evidencia3->alumnos;
